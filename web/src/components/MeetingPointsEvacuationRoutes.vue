  ...
  <div style="height: auto; width: 70%; margin: auto">
    ...
    <l-map :zoom="zoom" :center="center" style="height: 500px">
      ...
      >
        ...
        >
          <l-icon :icon-size="50" :icon-url="imagePersonRun" />
        ...
        >
          <l-icon :icon-size="30" :icon-url="imageEndFlag" />
        </l-marker>
      </l-polyline> </l-map
    ><br /><br />
...
import imagePersonRun from "../assets/icons/person_run.png";
import imageEndFlag from "../assets/icons/end_flag.png";
...
export default {
  ...
  data() {
    return {
      ...
      imagePersonRun: imagePersonRun,
      imageEndFlag: imageEndFlag,
    };
  },
